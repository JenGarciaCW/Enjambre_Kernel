...
socket_message uno(8705,"192.168.100.4",80000); //Creates a socket port, server, client, buffer size
...
int capture_main( )
{
	...
	system(" v4l2-ctl -d 1 --set-fmt-video=width=1920,height=1080,pixelformat=1 ");	 //Llamada al sistema para eliminar link simbólico
