...
AS5048::AS5048(unsigned char address, char bus, int buffersize) : i2cdevice(address,bus,buffersize){
...
void ITG3200::readgyro(){
	...
	this->readreg(0x1B);
	//this->temp=35.0+(((int16_t)((int)this->buffer[0]<<8 | (int) this->buffer[1]))+13200)/280.0;
	//this->xgyro =(float)((int16_t)(((int)this->buffer[2]<<8)|((int)this->buffer[3])))/14.375;
	//this->ygyro =(float)((int16_t)(((int)this->buffer[4]<<8)|((int)this->buffer[5])))/14.375;
	//this->zgyro =(float)((int16_t)(((int)this->buffer[6]<<8)|((int)this->buffer[7])))/14.375;
